...
<body class="theme-green">
                ...
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content modal-col-green card">
                        <div class="modal-header" style="padding:15px;background-color:#780e0e;">
                            <h4 class="modal-title" id="largeModalLabel">Category Details</h4>
                        </div>
                        	...
                        	<div class="row clearfix">
		                        <div class="col-xs-12 m-b-0">
		                            ...
		                            <div class="form-group">
		                                <div class="form-line">
		                                    <select id="category_id" name="category_id" class="form-control valid">
											</select>
		                                </div>
		                            </div>
		                        </div>
                       ...
                       <div class="modal-body body" style="background-color:white;">
                        	<div class="row clearfix">
		                        <div class="col-xs-12 m-b-0">
		                            ...
		                            <div class="form-group">
		                                <div class="form-line">
		                                    <input type="text" id="menu_details_title" name="menu_details_title" class="form-control valid" placeholder="Enter category Title" />
		                                </div>
		                            </div>
		                        </div>
							</div>
                       ...
                       <div class="modal-body body" style="background-color:white;">
                        	<div class="row clearfix">
		                        <div class="col-xs-12 m-b-0">
		                            ...
		                            <div class="form-group">
		                                <div class="form-line">
		                                    <textarea rows="5" id="menu_details_description" name="menu_details_description" class="form-control"></textarea>
    ...
    <script src="<?php echo base_url();?>/custom/web_content.js"></script>
