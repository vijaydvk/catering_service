...
<body class="theme-green">
    ...
    <section class="content">
        <div class="container-fluid">
			...
			<div class="col-md-12" style="margin-top:15px;" id="firstView">
								<table id="customerReportDetails" class="table table-striped table-bordered table-responsive nowrap" style="width:100%;font-size:12px;">
									<thead>
			...
			<div class="col-md-12" style="margin-top:15px;display:none;" id="secondView">
			<center><i class="material-icons" style="font-size: 48px;cursor:pointer;" id="closeDiv">keyboard_arrow_up</i></center>
								<table id="customerReportInvoiceDetails" class="table table-striped table-bordered table-responsive nowrap" style="width:100%;font-size:12px;">
									<thead>
									<style>th{background-color:#a05656;color:white;}</style>
										<th>Bill no</th>
										<th>Date</th>
    ...
    <script src="<?php echo base_url();?>/custom/customer_report.js"></script>
